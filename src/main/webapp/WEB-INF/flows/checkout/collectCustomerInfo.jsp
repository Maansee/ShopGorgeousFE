				...
				<div class="form-w3agileabc form1">
					...
					<form:form commandName="order" class="form-horizontal">
						...
						<div class="form-group">
							...
							<form:label path="cart.usercustomer.mailid">Email</form:label>
							<div class="key">
								<i class="glyphicon glyphicon-user" aria-hidden="true"></i>
								<form:input path="cart.usercustomer.mailid" />
								<div class="clearfix"></div>
							</div>


							<form:label path="cart.usercustomer.mobile">Mobile</form:label>
							<div class="key">
								<i class="glyphicon glyphicon-user" aria-hidden="true"></i>
								<form:input path="cart.usercustomer.mobile" />
								<div class="clearfix"></div>
							</div>
